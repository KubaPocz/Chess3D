...
namespace Game
{
    public static class GameEvents
    {
        ...
        public static event Action OnNetworkPlayerPrefabSpawnRequested;
        ...
        public static event Func<int, System.Threading.Tasks.Task<string>> HostAllocateRelayRequested;

        // Klient prosi o JoinRelay + StartClient (scena zsynchronizuje si� po po��czeniu)
        public static event Func<string, System.Threading.Tasks.Task> ClientJoinRelayRequested;
        ...
        {
            GameSettingsStore.CurrentSettings = new GameSettings(GameMode.HumanVsBot, playerColor,difficulty);
        ...
        public static void RequestNetworkPlayerPrefabSpawn() =>OnNetworkPlayerPrefabSpawnRequested?.Invoke();
