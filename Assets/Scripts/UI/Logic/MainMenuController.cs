...
namespace UI.Logic
{
    public class MainMenuController : MonoBehaviour
    {
        ...
        ChessColor _playerColor;
        int _gameDifficulty;
        readonly List<string> _currentPlayers = new();
        void Start()
        {
            ...
            //Offline Panel
            StartGameOfflineButton.onClick.AddListener(() => GameEvents.RequestStartGameOffline(_playerColor, _gameDifficulty));
        ...
        void HidePanel(Animator panelHide, Animator panelShow)
        {
        ...
        {
            if (playerName.Length >= 7 && !int.TryParse(playerName, out int id))
            {
        ...
        {
            codeLabel.text = code;
            // mo�esz te� automatycznie skopiowa� do schowka
